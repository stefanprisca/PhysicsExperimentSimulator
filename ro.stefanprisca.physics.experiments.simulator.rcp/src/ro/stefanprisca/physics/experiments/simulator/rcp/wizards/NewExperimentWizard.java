 ...
 * target container. The wizard creates one file with the extension "json". If a
...
public class NewExperimentWizard extends Wizard implements INewWizard {
	...
	private byte[] openContentStream(String newName) {
		String contents = GsonUtil.serialize(new Experiment(newName, "",
				new ArrayList<String>(), new ArrayList<Variable>(), UUID
						.randomUUID()));
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status = new Status(IStatus.ERROR,
				"ro.stefanprisca.physics.experiments.simulator.rcp",
