...
public class FieldEditorsPage extends FormPage {
	...
	protected void createFormContent(IManagedForm managedForm) {
        ...
        final Text exprNameTxt = toolkit.createText(body, editorInput.getName());
        ...
        final Section equationsSection = toolkit.createSection(body,ExpandableComposite.TWISTIE | ExpandableComposite.TITLE_BAR);
        equationsSection.setText("Experiment Equations");
        equationsSection.setLayoutData(new GridData(SWT.FILL, SWT.BEGINNING, true, false, 2, 3));
        ...
        GridData eqBtnData = new GridData(SWT.FILL, SWT.BEGINNING, false, false, 1, 1);
        
        Button addEq= toolkit.createButton(eqCont, "Add Equation", SWT.PUSH);
        addEq.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e){
				new InputDialog(body.getShell(), "Add an equation", "Add a new equation to the experiment","", null){
					@Override
        ...
        final Button editEq = toolkit.createButton(eqCont, "Edit Equation", SWT.PUSH);
        editEq.setEnabled(false);
        editEq.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e){
				new InputDialog(body.getShell(), "Edit Equation", "Edit the selected equation", eqList.getSelection()[0], null){
					@Override
					protected void okPressed() {
						// TODO Auto-generated method stub
        ...
        final Button removeEq = toolkit.createButton(eqCont, "Remove Equation", SWT.PUSH);
       ...
       // eqBtnData.horizontalIndent = 200;
        ...
        final Button moveEqUp = toolkit.createButton(eqCont, "Move Eq Up", SWT.PUSH);
        ...
        final Button moveEqDw = toolkit.createButton(eqCont, "Move Eq Down", SWT.PUSH);
...
equationsSection.addExpansionListener(new IExpansionListener() {
			...
			public void expansionStateChanged(ExpansionEvent e) {
				...
				eqList.removeAll();
				for(String s : input.getEquations()){
					eqList.add(s);
				}
				}
			}
        ...
        final Text descTxt = toolkit.createText(body, editorInput.getDescription(), SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
